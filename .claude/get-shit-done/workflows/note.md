...
- **Global scope**: `/home/aquarius/WebstormProjects/ai-sdlc/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/aquarius/WebstormProjects/ai-sdlc/.claude/notes/`)
...
2. Glob `/home/aquarius/WebstormProjects/ai-sdlc/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/aquarius/WebstormProjects/ai-sdlc/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/aquarius/WebstormProjects/ai-sdlc/.claude/notes/` — works in any directory
