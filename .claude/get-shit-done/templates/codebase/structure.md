...
- Usage: Reference from command with `@/home/aquarius/WebstormProjects/ai-sdlc/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/aquarius/WebstormProjects/ai-sdlc/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/aquarius/WebstormProjects/ai-sdlc/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
