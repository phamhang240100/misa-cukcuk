...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/aquarius/WebstormProjects/ai-sdlc/.claude
                  → checks /home/aquarius/WebstormProjects/ai-sdlc/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/aquarius/WebstormProjects/ai-sdlc/.claude/get-shit-done
                  → writes to /home/aquarius/WebstormProjects/ai-sdlc/.claude/get-shit-done/hooks/
...
@/home/aquarius/WebstormProjects/ai-sdlc/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/aquarius/WebstormProjects/ai-sdlc/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/home/aquarius/WebstormProjects/ai-sdlc/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/aquarius/WebstormProjects/ai-sdlc/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/aquarius/WebstormProjects/ai-sdlc/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
