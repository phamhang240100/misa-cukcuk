...
| 5 | POS | Lưu đơn — validate | Lưu → trạng thái **Chờ gửi đối tác**; validate COD ≤ hạn mức, vùng phủ, có kết nối Grab trước khi lưu. | FR-pos-010..012 |
| 6 | POS | Gửi đơn sang Grab | Nút **Gửi đơn hàng** → màn xem trước Hóa đơn giao hàng → gọi tạo vận đơn; **chống double-send** (khóa nút + Idempotency-Key); re-validate COD/vùng phủ; xử lý đủ nhánh lỗi 4xx/5xx/timeout/401. | FR-pos-020..025 · BR-016 |
| 7 | POS | Đồng bộ trạng thái (Hybrid auto-sync) | Tài xế lấy hàng (PICKING_UP) → **tự chuyển Đang giao hàng**, **bỏ nút "Giao hàng" thủ công**; đồng bộ đa thiết bị cùng chi nhánh; **dự phòng polling** khi webhook mất/trễ. | FR-pos-030..034 · BR-007,011,012 |
...
| 9 | POS | Xử lý trạng thái kết thúc xấu | **CANCELED/FAILED** → tự mở lại về Chờ gửi đối tác + cờ đỏ; **RETURNED** → nhắc thu ngân chọn; cho **Gửi lại / Đổi đối tác / Hủy** (dùng lại đơn cũ, không tạo HĐ trùng); Hủy sang Grab chỉ khi còn hủy được. | FR-pos-050..054 · BR-013,014,015,017 |
