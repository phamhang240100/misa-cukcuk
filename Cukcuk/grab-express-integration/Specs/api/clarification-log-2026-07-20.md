...
| 4 | `IN_RETURN` map sang trạng thái/nút gì? | **Giữ "Đang giao hàng" + nhãn phụ "Đang hoàn hàng", không nút** (kể cả Hủy) | Khác `FAILED` vì hàng đã rời quán, đang trên xe tài xế quay về — quán chưa cầm lại để kiểm tra |
