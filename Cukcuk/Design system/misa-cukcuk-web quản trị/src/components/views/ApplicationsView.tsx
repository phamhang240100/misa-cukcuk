    ...
    if (isQrModalOpen) {
      return (
        <div className="fixed inset-0 z-[9999] flex flex-col h-screen w-screen animate-fade-in select-none bg-[#F0F2F4] font-sans">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[#047857] text-[13px] mt-0.5 font-sans leading-relaxed">
                        Hệ thống đã tự động liên kết các danh mục dựa theo độ tương đồng, vui lòng đối chiếu lại và điều chỉnh giá bán nếu cần thiết.
                      </p>
                    </div>
                  </div>
                  <button
                    ...
                    <div className="flex-1 flex flex-col overflow-hidden w-full h-full text-left bg-white">
                      ...
                      <div className="px-6 border-b border-[#E9EAEB] flex items-center justify-between select-none bg-white">
                        <div className="flex gap-6">
                          ...
                          >
                            <span>Thực đơn ({wizardFoods.length})</span>
          ...
          {/* Warning and Sync Confirmation Combined Popup with high z-index (z-[10000]) */}
          {showShopeeSyncConfirmModal && (
            <div className="fixed inset-0 bg-black/60 z-[10000] flex items-center justify-center p-4 animate-fade-in">
              <div className="bg-white rounded-xl shadow-2xl border border-[#E9EAEB] w-full max-w-[460px] overflow-hidden animate-scale-up p-6 flex flex-col items-center text-center relative">
                {/* Close Button X */}
                <button
                ...
                {(() => {
                  ...
                  const totalUnlinked = countDishes + countGroups + countStpv + countStpvGroups;

                  return (
                    <>
                      {totalUnlinked > 0 ? (
                        <>
                          <div className="w-12 h-12 rounded-full bg-[#F0F6FE] flex items-center justify-center mb-4 flex-shrink-0">
                            <RefreshCw className="w-6 h-6 text-[#245FDF]" />
                          </div>

                          <h3 className="text-[#101828] font-bold text-[18px] leading-6 mb-2 font-sans">
                            Đồng bộ thực đơn lên ShopeeFood
                          </h3>

                          <p className="text-[#475467] text-[13px] leading-relaxed mb-4 font-sans">
                            Bạn có muốn đồng bộ thực đơn lên ShopeeFood luôn không?
                          </p>

                          {/* Warning Alert Banner - Combined & Detailed */}
                          <div className="bg-[#FFF9E6] border border-[#FFE4A0] rounded-lg p-3.5 mb-5 text-left w-full select-none">
                            <div className="flex gap-2 items-start">
                              <AlertTriangle className="w-4.5 h-4.5 text-amber-600 mt-0.5 flex-shrink-0" />
                              <div className="flex-1">
                                <p className="text-[#92400E] text-[13px] font-semibold leading-normal font-sans">
                                  Chưa hoàn tất liên kết thực đơn ({totalUnlinked} mục)
                                </p>
                                <p className="text-[#B45309] text-[12px] mt-1 leading-normal font-sans">
                                  Các danh mục chưa được liên kết sẽ bị xoá sau khi đồng bộ thực đơn lên ShopeeFood. Vui lòng kiểm tra lại danh sách bên dưới.
                                </p>

                                <div className="mt-3 pt-2.5 border-t border-[#FFE4A0] flex flex-col gap-1.5">
                                  <span className="text-[12px] font-semibold text-[#92400E] font-sans">
                                    Danh sách chưa liên kết:
                                  </span>
                                  <ul className="list-none pl-0 m-0 text-[12px] text-[#B45309] font-sans flex flex-col gap-1">
                                    {countDishes > 0 && (
                                      <li className="flex items-center gap-1.5">
                                        <span className="w-1.5 h-1.5 rounded-full bg-amber-500 flex-shrink-0" />
                                        <span>Thực đơn: <strong>{countDishes}</strong> món chưa liên kết</span>
                                      </li>
                                    )}
                                    {countGroups > 0 && (
                                      <li className="flex items-center gap-1.5">
                                        <span className="w-1.5 h-1.5 rounded-full bg-amber-500 flex-shrink-0" />
                                        <span>Nhóm thực đơn: <strong>{countGroups}</strong> nhóm chưa liên kết</span>
                                      </li>
                                    )}
                                    {countStpv > 0 && (
                                      <li className="flex items-center gap-1.5">
                                        <span className="w-1.5 h-1.5 rounded-full bg-amber-500 flex-shrink-0" />
                                        <span>Sở thích phục vụ: <strong>{countStpv}</strong> sở thích chưa liên kết</span>
                                      </li>
                                    )}
                                    {countStpvGroups > 0 && (
                                      <li className="flex items-center gap-1.5">
                                        <span className="w-1.5 h-1.5 rounded-full bg-amber-500 flex-shrink-0" />
                                        <span>Nhóm STPV: <strong>{countStpvGroups}</strong> nhóm chưa liên kết</span>
                                      </li>
                                    )}
                                  </ul>
                                </div>
                          ...
                          {/* 2 action buttons as requested: "Tiếp tục mà không đồng bộ" and "Đồng bộ ngay" */}
                          <div className="flex gap-2 w-full justify-between items-center">
                            <button
                              ...
                              className="flex-1 py-1.5 bg-white hover:bg-gray-50 text-[#475467] border border-[#D5D7DA] font-semibold text-[13px] rounded-lg transition-all cursor-pointer h-8 flex items-center justify-center"
                              style={{ minWidth: "84px" }}
                            >
                              Để sau
                            </button>
                            <button
                              ...
                              className="flex-1 py-1.5 bg-[#245FDF] hover:bg-[#1B4EBA] text-white font-semibold text-[13px] rounded-lg transition-all cursor-pointer h-8 flex items-center justify-center border-none shadow-sm"
                              style={{ minWidth: "84px" }}
                            >
                              Đồng bộ ngay
                            </button>
                        ...
                        <>
                          ...
                          <div className="flex gap-3 w-full">
                            <button
                              ...
                              className="flex-1 py-1.5 bg-white hover:bg-gray-50 text-[#101828] border border-[#D5D7DA] font-semibold text-[13px] rounded-lg transition-all cursor-pointer h-8 flex items-center justify-center"
                              style={{ minWidth: "84px" }}
                            >
                              Để sau
                            </button>
                        ...
                        <table className="w-full text-left border-collapse select-none">
                          <thead>
                            <tr className="select-none">
                              <th className="px-4 py-2 border-r border-[#E9EAEB] text-center w-20 align-middle sticky top-0 bg-[#FAFAFA] z-10 shadow-[inset_0_-1px_0_#E9EAEB]">
                              ...
                              <th className="px-4 py-2 border-r border-[#E9EAEB] text-center min-w-[180px] align-middle sticky top-0 bg-[#FAFAFA] z-10 shadow-[inset_0_-1px_0_#E9EAEB]">
                              ...
                              <th className="px-4 py-2 border-r border-[#E9EAEB] text-center w-44 align-middle sticky top-0 bg-[#FAFAFA] z-10 shadow-[inset_0_-1px_0_#E9EAEB]">
                                <div className="flex flex-col justify-between items-center h-[76px] w-full">
                                  <div className="flex-1 flex items-center justify-center text-center w-full leading-tight">
                                    <span className="text-[13px] font-semibold text-[#101828] font-sans">
                                      Nhóm thực đơn
                              ...
                              <th className="px-4 py-2 border-r border-[#E9EAEB] text-center w-28 align-middle sticky top-0 bg-[#FAFAFA] z-10 shadow-[inset_0_-1px_0_#E9EAEB]">
                                <div className="flex flex-col justify-between items-center h-[76px] w-full">
                                  <div className="flex-1 flex items-center justify-center text-center w-full leading-tight">
                                    <span className="text-[13px] font-semibold text-[#101828] font-sans">
                                      Đơn vị tính
                              ...
                              <th className="px-4 py-2 border-r border-[#E9EAEB] text-center w-48 align-middle sticky top-0 bg-[#FAFAFA] z-10 shadow-[inset_0_-1px_0_#E9EAEB]">
                                <div className="flex flex-col justify-between items-center h-[76px] w-full">
                                  <div className="flex-1 flex items-center justify-center text-center w-full leading-tight">
                              ...
                              <th className="px-4 py-2 text-center w-36 align-middle sticky top-0 bg-[#FAFAFA] z-10 shadow-[inset_0_-1px_0_#E9EAEB]">
                                <div className="flex flex-col justify-between items-center h-[76px] w-full">
                                  <div className="flex-1 flex items-center justify-center text-center w-full leading-tight">
                                    <span className="text-[13px] font-semibold text-[#101828] font-sans">
                                      Trạng thái
                              ...
                              <table className="w-full text-left border-collapse select-none">
                                <thead className="sticky top-0 bg-[#F7F7F8] z-10 border-b border-[#E9EAEB]">
                                  <tr className="bg-[#F7F7F8] select-none text-[13px] text-[#101828] font-semibold align-middle">
                                    ...
                                    <th className="px-4 py-2 text-center w-48 align-middle">
                                      <div className="flex flex-col justify-between items-center h-[76px] w-full">
                                        <div className="flex-1 flex items-center justify-center text-center w-full leading-tight">
                                          <span className="font-semibold text-[#101828] font-sans">
                                            Trạng thái
                              ...
                              <table className="w-full text-left border-collapse select-none">
                                <thead className="sticky top-0 bg-[#FAFAFA] z-10 border-b border-[#E9EAEB]">
                                  <tr className="bg-[#FAFAFA] select-none text-[13px] text-[#101828] font-semibold align-middle">
                                    ...
                                    <th className="px-4 py-2 text-center w-52 align-middle">
                                      <div className="flex flex-col justify-between items-center h-[76px] w-full">
                                        <div className="flex-1 flex items-center justify-center text-center w-full leading-tight">
                                          <span className="font-semibold text-[#101828] font-sans">
                                            Trạng thái
      ...
      return (
        <div className="fixed inset-0 bg-[#F0F2F4] z-[10030] flex flex-col font-sans select-none overflow-hidden text-left animate-fade-in">
          ...
          <div className="bg-white border-b border-[#E9EAEB] px-6 h-12 flex items-center justify-between flex-shrink-0 select-none">
            <div className="flex items-center gap-6 h-full overflow-x-auto whitespace-nowrap">
              ...
              >
                <div className="flex items-center gap-1.5 h-full">
                  <span>Thực đơn ({quickLinkEditingItems.length})</span>
                  {unlinkedDishesCount > 0 && (
                    <AlertTriangle className="w-4 h-4 text-[#F59E0B] stroke-[2.5px]" />
                  )}
                </div>
              ...
              <button
                ...
                onClick={() => {
                  ...
                  setQuickLinkPage(1);
                  setQuickLinkStatusFilter("");
                  setQuickLinkMenuGroupStatusFilter("");
                  setQuickLinkMenuGroupNameSearch("");
                  setQuickLinkMenuGroupDescSearch("");
                  setQuickLinkMenuGroupCukCukSearch("");
                  setQuickLinkActiveDropdownId(null);
              ...
              >
                <div className="flex items-center gap-1.5 h-full">
                  <span>Nhóm thực đơn ({quickLinkEditingMenuGroups.length})</span>
                  {unlinkedMenuGroupsCount > 0 && (
                    <AlertTriangle className="w-4 h-4 text-[#F59E0B] stroke-[2.5px]" />
                  )}
                </div>
              ...
              >
                <div className="flex items-center gap-1.5 h-full">
                  <span>Sở thích phục vụ ({quickLinkEditingStpv.length})</span>
                  {unlinkedStpvsCount > 0 && (
                    <AlertTriangle className="w-4 h-4 text-[#F59E0B] stroke-[2.5px]" />
                  )}
                </div>
              ...
              <button
                ...
                onClick={() => {
                  ...
                  setQuickLinkPage(1);
                  setQuickLinkStatusFilter("");
                  setQuickLinkStpvGroupStatusFilter("");
                  setQuickLinkStpvGroupNameSearch("");
                  setQuickLinkStpvGroupDescSearch("");
                  setQuickLinkStpvGroupCukCukSearch("");
                  setQuickLinkActiveDropdownId(null);
              ...
              >
                <div className="flex items-center gap-1.5 h-full">
                  <span>Nhóm SPTV ({quickLinkEditingStpvGroups.length})</span>
                  {unlinkedStpvGroupsCount > 0 && (
                    <AlertTriangle className="w-4 h-4 text-[#F59E0B] stroke-[2.5px]" />
                  )}
                </div>
            ...
            {/* Warning text on the right side if there are unlinked items in the current active tab */}
            {((quickLinkTab === "dish" && unlinkedDishesCount > 0) ||
              (quickLinkTab === "menuGroup" && unlinkedMenuGroupsCount > 0) ||
              (quickLinkTab === "stpv" && unlinkedStpvsCount > 0) ||
              (quickLinkTab === "stpvGroup" && unlinkedStpvGroupsCount > 0)) && (
              <div className="flex items-center gap-1.5 text-[#B45309] font-medium text-[13px] font-sans flex-shrink-0 animate-fade-in">
                <AlertTriangle className="w-4 h-4 text-[#F59E0B] stroke-[2.5px]" />
                <span>
                  {quickLinkTab === "dish" && `Có ${unlinkedDishesCount}/${quickLinkEditingItems.length} món ăn chưa được liên kết`}
                  {quickLinkTab === "menuGroup" && `Có ${unlinkedMenuGroupsCount}/${quickLinkEditingMenuGroups.length} nhóm thực đơn chưa được liên kết`}
                  {quickLinkTab === "stpv" && `Có ${unlinkedStpvsCount}/${quickLinkEditingStpv.length} sở thích phục vụ chưa được liên kết`}
                  {quickLinkTab === "stpvGroup" && `Có ${unlinkedStpvGroupsCount}/${quickLinkEditingStpvGroups.length} nhóm STPV chưa được liên kết`}
                </span>
              </div>
            )}
          </div>
                  ...
                  {quickLinkTab === "dish" ? (
                    <>
                      ...
                      <thead>
                        <tr className="bg-[#F7F7F8] border-b border-[#E9EAEB]">
                          {/* Col 1: Ảnh */}
                          <th className="px-4 py-2 text-center align-middle h-[76px] border-r border-[#E9EAEB] sticky top-0 bg-[#F7F7F8] z-10 shadow-[inset_0_-1px_0_#E9EAEB]">
                            <span className="text-[13px] font-semibold text-[#101828] font-sans">
                              Ảnh
                            </span>
                          </th>
                          ...
                          <th className="px-4 py-2 text-center align-middle h-[76px] border-r border-[#E9EAEB] sticky top-0 bg-[#F7F7F8] z-10 shadow-[inset_0_-1px_0_#E9EAEB]">
                            <div className="flex flex-col justify-between items-center h-full w-full">
                              ...
                              <div className="w-full mt-1.5 flex border border-[#D5D7DA] rounded-[8px] bg-white h-7 items-center overflow-hidden font-normal relative">
                                <select
                                  value={quickLinkPriceOpFilter}
                                  onChange={(e) => {
                                    setQuickLinkPriceOpFilter(e.target.value);
                                    setQuickLinkPage(1);
                                  }}
                                  className="w-11 h-full border-r border-[#D5D7DA] bg-[#F2F4F7] text-[#101828] text-[12px] font-semibold outline-none appearance-none cursor-pointer text-center px-1 font-sans"
                                >
                          ...
                          {/* Col 6: Trạng thái liên kết */}
                          <th className="px-4 py-2 text-left align-middle h-[76px] border-r border-[#E9EAEB] sticky top-0 bg-[#F7F7F8] z-10 shadow-[inset_0_-1px_0_#E9EAEB]">
                          ...
                          {/* Col 8: Món tương ứng trên MISA CukCuk */}
                          <th className="px-4 py-2 text-center align-middle h-[76px] border-r border-[#E9EAEB] sticky top-0 bg-[#F7F7F8] z-10 shadow-[inset_0_-1px_0_#E9EAEB]">
                            <div className="flex flex-col justify-between items-center h-full w-full">
                              <span className="text-[13px] font-semibold text-[#101828] font-sans">
                                Món tương ứng trên MISA CukCuk
                          ...
                          {/* Col 9: Thao tác */}
                          <th className="px-4 py-2 text-center align-middle h-[76px] sticky top-0 bg-[#F7F7F8] z-10 shadow-[inset_0_-1px_0_#E9EAEB]">
                            <span className="text-[13px] font-semibold text-[#101828] font-sans">
                              Thao tác
                            </span>
                          </th>
                      ...
                      <tbody className="divide-y divide-[#E9EAEB]">
                        {paginatedItems.length > 0 ? (
                          paginatedItems.map((item) => {
                            ...
                            return (
                              <tr key={item.id} className="hover:bg-[#EDFCF4]/40 border-b border-[#E9EAEB] transition-colors h-14">
                                ...
                                {/* Col 5: Giá bán trên ShopeeFood */}
                                <td className="px-4 py-1.5 border-r border-[#E9EAEB] text-right text-[13px] font-semibold text-[#101828] font-sans">
                                ...
                                {/* Col 9: Hủy liên kết action column */}
                          ...
                          <tr>
                            <td colSpan={9} className="text-center py-10 text-[#717680] text-[13px]">
                    ...
                    <>
                      ...
                      <thead>
                        <tr className="bg-[#F7F7F8] border-b border-[#E9EAEB]">
                          ...
                          {/* Col 4: Nhóm thực đơn tương ứng trên MISA CukCuk */}
                          <th className="px-4 py-2 text-center align-middle h-[76px] border-r border-[#E9EAEB]">
                            <div className="flex flex-col justify-between items-center h-full w-full">
                              <span className="text-[13px] font-semibold text-[#101828] font-sans">
                                Nhóm thực đơn tương ứng trên MISA CukCuk
                    ...
                    <>
                      ...
                      <thead>
                        <tr className="bg-[#F7F7F8] border-b border-[#E9EAEB]">
                          ...
                          {/* Col 5: STPV tương ứng trên MISA CukCuk */}
                          <th className="px-4 py-2 text-center align-middle h-[76px] border-r border-[#E9EAEB]">
                            <div className="flex flex-col justify-between items-center h-full w-full">
                              <span className="text-[13px] font-semibold text-[#101828] font-sans">
                                STPV tương ứng trên MISA CukCuk
                    ...
                    <>
                      ...
                      <thead>
                        <tr className="bg-[#F7F7F8] border-b border-[#E9EAEB]">
                          ...
                          {/* Col 4: Nhóm STPV tương ứng trên MISA CukCuk */}
                          <th className="px-4 py-2 text-center align-middle h-[76px] border-r border-[#E9EAEB]">
                            <div className="flex flex-col justify-between items-center h-full w-full">
                              <span className="text-[13px] font-semibold text-[#101828] font-sans">
                                Nhóm STPV tương ứng trên MISA CukCuk
