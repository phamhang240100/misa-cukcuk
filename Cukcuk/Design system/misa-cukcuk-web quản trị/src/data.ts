...
export const SIDEBAR_ITEMS: SidebarMenuItem[] = [
  { id: 'ban-lam-viec', title: 'Bàn làm việc', iconName: 'Briefcase' },
  { id: 'tong-quan', title: 'Tổng quan', iconName: 'Compass' },
  { id: 'bao-cao', title: 'Báo cáo', iconName: 'PieChart', hasArrow: true },
  ...
  { 
    ...
    iconName: 'Store', 
    isChannel: true, 
    channelColor: 'bg-[#1E62EC]', 
    isHeaderBefore: true, 
    headerTitle: 'KÊNH BÁN HÀNG' 
  },
  { id: 'qr-order', title: 'QR Order', iconName: 'QrCode', isChannel: true, channelColor: 'bg-[#9333EA]' },
  { id: 'website-order', title: 'Website Order', iconName: 'Globe', isChannel: true, channelColor: 'bg-[#EA580C]' },
  { id: 'zalo-mini-app', title: 'Zalo Mini app', iconName: 'AppWindow', isChannel: true, channelColor: 'bg-[#2563EB]' },
  { id: 'food-delivery', title: 'Food Delivery', iconName: 'Bike', isChannel: true, channelColor: 'bg-[#16A34A]' },
  
  // Bottom section
  { id: 'khuyen-mai', title: 'Khuyến mại', iconName: 'Gift', isSeparatorBefore: true },
