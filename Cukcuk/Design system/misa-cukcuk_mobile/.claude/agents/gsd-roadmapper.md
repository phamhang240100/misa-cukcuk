...
Reference full template: `/home/aquarius/WebstormProjects/ai-sdlc/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/aquarius/WebstormProjects/ai-sdlc/.claude/get-shit-done/templates/state.md`.
